...
# Setup linkerd (and make the script executable)
chmod +x ./linkerd.sh
./linkerd.sh
...
# Setup DYNAMOS (and make the script executable)
chmod +x ./dynamos-configuration.sh
...
# Setup monitoring (and make the script executable)
